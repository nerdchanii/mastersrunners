...
const WORKOUT_TYPE_SEEDS = [
  // LONG_RUN
  {
    category: "LONG_RUN",
    name: "LSD",
    description: "느린 장거리 달리기",
    sortOrder: 0,
  },
  {
    category: "LONG_RUN",
    name: "SUSTAINED",
    description: "일정 페이스 장거리",
    sortOrder: 1,
  },
  {
    category: "LONG_RUN",
    name: "TIME_BASED",
    description: "시간 기준 장거리",
    sortOrder: 2,
  },
  // SPEED
  {
  ...
  // EASY
  {
    category: "EASY",
    name: "EASY_RUN",
    description: "편안한 페이스 달리기",
    sortOrder: 0,
  },
  {
    category: "EASY",
    name: "RECOVERY",
    description: "회복 목적 저강도",
    sortOrder: 1,
  },
  {
    category: "EASY",
...
async function main() {
  ...
  for (const seed of WORKOUT_TYPE_SEEDS) {
    await prisma.workoutType.upsert({
      where: {
        category_name: { category: seed.category, name: seed.name },
      },
      update: {
