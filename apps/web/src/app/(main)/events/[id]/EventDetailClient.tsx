  ...
  if (!eventId || eventId === "_") {
    return (
      <div className="max-w-3xl mx-auto text-center py-12">
        ...
        <button onClick={() => router.push("/events")} className="mt-4 text-indigo-600 hover:underline">
          대회 목록으로 돌아가기
        </button>
      </div>
    );
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex justify-center">
        <button onClick={() => router.push("/events")} className="px-6 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
          목록으로
        </button>
      </div>
    </div>
